...
public class MainActivity extends AppCompatActivity {
    ...
    @BindView(com.articles.nytimes.R.id.recycler_news)
    RecyclerView recyclerView;
    @BindView(com.articles.nytimes.R.id.textViewNoData)
    TextView noDataTv;
    @BindView(com.articles.nytimes.R.id.progressBar)
    ProgressBar progressBar;
    @BindView(com.articles.nytimes.R.id.action_search)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.articles.nytimes.R.layout.activity_main);

        inits();

        getArticles(getString(com.articles.nytimes.R.string.one));
    }
    ...
    private void inits() {
        ...
        progressBar =  findViewById(com.articles.nytimes.R.id.progressBar);
        noDataTv =  findViewById(com.articles.nytimes.R.id.textViewNoData);
        recyclerView =  findViewById(com.articles.nytimes.R.id.recycler_news);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(com.articles.nytimes.R.menu.menu_options, menu);

        // Associate searchable configuration with the SearchView
        SearchManager searchManager = (SearchManager) getSystemService(Context.SEARCH_SERVICE);
        searchView = (SearchView) menu.findItem(com.articles.nytimes.R.id.action_search)
                .getActionView();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case com.articles.nytimes.R.id.latest_one:
                getArticles(getString(com.articles.nytimes.R.string.one));
                return true;
            case com.articles.nytimes.R.id.latest_seven:
                getArticles(getString(com.articles.nytimes.R.string.seven));
                return true;
            case com.articles.nytimes.R.id.latest_thirty:
                getArticles(getString(com.articles.nytimes.R.string.thirty));
                return true;
            //noinspection SimplifiableIfStatement
            case com.articles.nytimes.R.id.action_search:
                return true;
            default:
